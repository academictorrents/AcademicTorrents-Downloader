...
Constants 
{
  ...
  public static final String AZUREUS_VERSION  = "5.3.0.1_B35";
  public static final String BUILD_VERSION  = "5301-35";   //Ant replace
  	...
  	String	version )
  {
	...
	{	
		try{
			version_1 = version_1.replaceAll( "_B35", "_B100" );
			version_2 = version_2.replaceAll( "_B35", "_B100" );
