...
public class Peer implements Comparable<Peer>
{
    ...
    public void runConnection (PeerListener listener, BitField bitfield)
    {
        ...
        try {
            ...
            if (din == null) {
                ...
                byte[] id = handshake(bis, bos);
                // If peer list was binary encoded, the peer id was not given,
                // and therefore is set to null under creation [LIMA].
                if(peerID.getID() == null)
                	peerID.setID(id);
    ...
    /**
     * Returns a bitfield representing the pieces that the peer has [LIMA].
     */
    public BitField getHaves() {
